...
public final class PostFileCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(PostFileCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    if(parameters.containsKey("title") && parameters.get("title") != null && parameters.get("title").get() != null) {
      convertedParameters.put("title", parameters.get("title").get());
      if(!(convertedParameters.get("title") instanceof String)) {
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("sessionName"),(String)convertedParameters.get("channel"),(String)convertedParameters.get("file"),(String)convertedParameters.get("title")));
