...
public final class GetMessagesCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(GetMessagesCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    GetMessages command = new GetMessages();
