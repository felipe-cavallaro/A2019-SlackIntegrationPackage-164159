...
@CommandPkg(
        ...
        name = "Archive Channel", label = "Archive Channel",
        node_label = "Archive channel {{channel}} in session {{sessionName}}", description = "Archive Channel in Slack", icon = "SLACK.svg",
